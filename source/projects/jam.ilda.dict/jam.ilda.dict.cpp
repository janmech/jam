...
public:
    ...
    MIN_DESCRIPTION     { "Create a dictionary from an ILDA file with file information.<br/><br/>For more information about the ILDA file structure open the <i>Jam Package Overview</i> in the documentation browser and read the topic about <i>ILDA Files</i>" };
    MIN_TAGS            { "ILDA" };
    MIN_AUTHOR          { "Jan Mech" };
