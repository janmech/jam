...
function init()
{
    ...
    if(a==null)
    {
		...
		this.patcher.message("script", "newobject", "newobj", "@text","jsui @filename jam.helpname.js @jsarguments " + jsarguments[1] + " @patching_rect 10. 10. 305. 55.");
		...
		basic.subpatcher().message("script", "newobject", "newobj", "@text","jsui @filename jam.helpdetails.js @jsarguments " + jsarguments[1] + " @patching_rect 10. 10. 620. 125.");
		basic.subpatcher().message("script", "newobject", "newobj", "@text","jsui @filename jam.helpargs.js @jsarguments " + jsarguments[1] + " @patching_rect 185. 285. 295. 70.");
	}
